    ...
    <>
      <ThemeProvider attribute="class">
        <main>
          ...
          <section
            ref={aboutRef}
            className="grid lg:grid-cols-3 px-4 xl:px-32 gap-24 xl:gap-32 py-24 xl:py-48 bg-gradient-to-b from-primary-white through-white to-white dark:from-secondary-000 dark:through-secondary-100 dark:to-secondary-100"
          >
            {aboutArr.map((about) => (
          ...
          >
            ...
            <div
              className={`grid gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-center justify-content-center`}
            >
              <div
                className={`relative flex w-64 h-64 max-w-full aspect-square m-auto`}
              >
                <span
                  className={`absolute flex w-12 h-12 rounded-full bg-additional-green right-[4%] top-[4%] border-8 border-white dark:border-secondary-100 `}
                ></span>
                <Image
                  src="/profile.png"
              ...
              <div className={`max-w-64 mx-auto md:max-w-full`}>
                <h1 className={`text-xl md:text-4xl mb-6`}>Hey</h1>
                <p className={`mb-4`}>
                ...
                <Button
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/in/fryderyk-boncler/",
                      "_blank",
                      "noreferrer"
                    )
                  }
